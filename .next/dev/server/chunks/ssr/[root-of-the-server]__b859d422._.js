...
const getAdminApiBaseUrl = ()=>trimTrailingSlash(getConfiguredValue(process.env.ADMIN_API_BASE_URL, getConfiguredValue(process.env.NEXT_PUBLIC_API_URL, DEFAULT_ADMIN_API_BASE_URL)));
